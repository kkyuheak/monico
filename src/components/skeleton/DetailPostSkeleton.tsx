...
const DetailPostSkeleton = () => {
  return (
    <div className="p-1 animate-pulse mt-[18px]">
      {/* 제목 */}
      <div className="w-3/4 h-7 bg-gray-300 dark:bg-gray-600 rounded mb-4" />
      ...
      <div className="flex gap-2 overflow-auto mb-4">
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="w-[240px] h-[360px] bg-gray-300 dark:bg-gray-600 rounded"
          />
        ))}
      </div>
      ...
      <div className="flex gap-2 h-[25px] mb-6">
        <div className="w-14 h-5 bg-gray-300 dark:bg-gray-600 rounded-full" />
      ...
      {/* 댓글 */}
      <div className="mb-2">
        <div className="w-20 h-5 bg-gray-300 dark:bg-gray-600 rounded mb-4" />
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex items-start gap-2 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="w-72 h-4 bg-gray-200 dark:bg-gray-600 rounded" />
              <div className="w-60 h-4 bg-gray-200 dark:bg-gray-600 rounded" />
            </div>
          </div>
        ))}
      </div>
