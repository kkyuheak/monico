  ...
  return (
    <>
      <div className="w-full p-2 rounded-lg animate-pulse">
        ...
        {/* 제목 */}
        <div className="w-3/4 h-5 bg-gray-300 dark:bg-gray-600 rounded mb-2" />

        {/* 설명 */}
        <div className="w-full h-4 bg-gray-200 dark:bg-gray-600 rounded mb-1" />
        <div className="w-5/6 h-4 bg-gray-200 dark:bg-gray-600 rounded mb-1" />
