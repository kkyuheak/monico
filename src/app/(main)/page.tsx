    ...
    <div className="">
      ...
      >
        ...
        <div className="z-10  pl-8">
          ...
          <MainButton
            link="/coin"
            css="w-[131px] h-[48px] text-[#121712] rounded-[24px] font-bold text-[16px] bg-[#4FD12B] mt-4 mb-[23px]"
          >
            시작하기
          </MainButton>
        </div>
      ...
      <section className="text-[#121712] mt-[40px]">
      ...
      <section className="mt-[100px] text-[#121712] text-center">
